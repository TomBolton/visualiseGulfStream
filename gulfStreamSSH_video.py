...
# load data
adt = np.transpose( sio.loadmat('data/aviso_adt_93_24yrs.mat')['adt'], (1,0,2) )
...
# get projections for various places
...
with writer.saving( fig, "gulfStreamSSH_b.mp4", 400 ) :

    for t in range(8766 - 366 - 365 - 365, 8766, 1):

        print t-7670, " / ", 365*3+1
        ...
        cf = map.contourf(x, y, adt[:, :, t], levels=adtSpacings, extend='max',
